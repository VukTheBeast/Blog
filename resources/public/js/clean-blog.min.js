...
$(function(){
  ...
  $("input,textarea").jqBootstrapValidation({
    ...
    submitSuccess:function(a,b){
                  ...
                  var c=$("input#name").val(),
                      ...
                      g=c;
                      g.indexOf(" ")>=0&&(g=c.split(" ").slice(0,-1).join(" ")),
  $.ajax({
    url:"/comment",
    type:"POST",
    data:{id:h,name:c,message:f},
    cache:!1,
    success:function(){
            $("#success").html("<div class='alert alert-success'>"),
            $("#success > .alert-success").html("<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;").append("</button>"),

            $("#success > .alert-success").append("<strong>Your comment has been sent. </strong>"),
  ...
  //u slucaju kada je rating
  if(typeof $('.id').val() != "undefined" && typeof $('#name').val() != "undefined"){
    var   rating= 0;
    $(".rate").click(function(){

      //function za vrednost rejtinga
  ...
  $.ajax({
    url:"/rate",
    type:"POST",
    data:{id:h,name:c,rat_val:f},
    cache:!1,
    success:function(){
            $("#success").html("<div class='alert alert-success'>"),
            $("#success > .alert-success").html("<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;").append("</button>"),

            $("#success > .alert-success").append("<strong>Your rating has been sent. </strong>"),
            $("#success > .alert-success").append("</div>"),$("#contactForm").trigger("reset")
    },
    error:function(){
          $("#success").html("<div class='alert alert-danger'>"),
  ...
  //za admin deo, ajax post
  else if(typeof $('#title').val() != "undefined"){
    $("input,textarea").jqBootstrapValidation({
    preventSubmit:!0,
    submitError:function(){},
    submitSuccess:function(a,b){
                  b.preventDefault();
                  var c=$("input#title").val(),
                      h=$('input#subtitle').val(),
                      d=$("textarea#content").val(),
                      e=$("input#phone").val(),
                      f=$("textarea#message").val(),
                      g=c;
                      g.indexOf(" ")>=0&&(g=c.split(" ").slice(0,-1).join(" ")),
                  ...
                  $.ajax({
                    ...
                    success:function(){
                            ...
                            $("#success > .alert-success").append("<strong>Your successfuly add your awesome blog!!. </strong>"),
                            $("#success > .alert-success").append("</div>"),$("#BlogForm").trigger("reset")
                    },
                    error:function(){
                          $("#success").html("<div class='alert alert-danger'>"),
                          $("#success > .alert-danger").html("<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;").append("</button>"),
                          $("#success > .alert-danger").append("<strong>Sorry Admin, it seems that server is not responding. Please try again later!"),
                          $("#success > .alert-danger").append("</div>"),$("#BlogForm").trigger("reset")
                    }//end error
              })//end ajax
    },//end submitSuccess
    filter:function(){
  ...
  $.ajax({
    ...
    cache:!1,
    success:function(){$("#success").html("<div class='alert alert-success'>"),$("#success > .alert-success").html("<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;").append("</button>"),$("#success > .alert-success").append("<strong>Your message has been sent. </strong>"),$("#success > .alert-success").append("</div>"),$("#contactForm").trigger("reset")},
    error:function(){$("#success").html("<div class='alert alert-danger'>"),$("#success > .alert-danger").html("<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;").append("</button>"),$("#success > .alert-danger").append("<strong>Sorry "+g+", it seems that my mail server is not responding. Please try again later!"),$("#success > .alert-danger").append("</div>"),$("#contactForm").trigger("reset")}})},//end submitSuccess
    filter:function(){
          return $(this).is(":visible")}
  });
  }
